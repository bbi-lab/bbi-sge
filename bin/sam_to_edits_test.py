...
# declaring variable names that get passed by argparser
working_dir = args.path
output_dir = args.output
# some ohter variable define....
...
with open(args.amp) as f:
	...
	for lines in f.readlines():
		...
		ref_file.close()
# experiment list
exp_groupings_list = sys.argv[4].split('+')
exp_groupings = {}
...
#CIGAR - indictaions of alignments for M(match/mismatch), D(deletion) and I(insertion)
...
for exp in exp_groupings.keys():
	...
	outfile_path = output_dir+'/'+exp+'.txt'
